  ...
  return (
    <>
        ...
        <div className="wrap">
          <div>
            <div className="footer-social">
              <a href="https://de.linkedin.com/company/pagel-spezial-beton" target="_blank" rel="noreferrer" aria-label="LinkedIn">
              ...
              <a href="https://www.facebook.com/pagelspezialbeton" target="_blank" rel="noreferrer" aria-label="Facebook">
              ...
              <a href="https://www.instagram.com/pagelspezialbeton" target="_blank" rel="noreferrer" aria-label="Instagram">
              ...
              <a href="https://www.youtube.com/channel/UCV76Db02sbzgSSXLeTfNTzg" target="_blank" rel="noreferrer" aria-label="YouTube">
          ...
          <div className="footer-nav">
            <div className="footer-nav-col">
              <h4>Продукти</h4>
              <a href="/products/evoline">evoline</a>
              <a href="/products/grout">Заливальні розчини</a>
              <a href="/products/concrete-repair">Ремонт бетону</a>
              <a href="/products/industrial-floors">Промислові підлоги</a>
              <a href="/products/reaction-resins">Реакційні смоли</a>
            </div>
            <div className="footer-nav-col">
              <h4>PAGEL</h4>
              <a href="/innovations">Інновації</a>
              <a href="/references">Референції</a>
              <a href="/quality-assurance">Контроль якості</a>
              <a href="/contact">Контакти</a>
              <a href="/site-notice">Правова інформація</a>
              <a href="/privacy-policy">Конфіденційність</a>
              <div className="possehl-logo">
      ...
      <footer className="site-footer">
        <div className="wrap">
          <p>Copyright © 2026 · PAGEL Spezial-Beton GmbH &amp; Co. KG · Wolfsbankring 9, D-45355 Essen · <a href="mailto:info@pagel.com">info@pagel.com</a></p>
        </div>
      </footer>
    </>
  );
